---
source_url: https://labtestsonline.org.uk/tests/glucose-tests
...
Title: Lab Tests Online UK | Glucose Tests

URL Source: https://labtestsonline.org.uk/tests/glucose-tests

Markdown Content:
# Lab Tests Online UK | Glucose Tests
[Skip to main content](https://labtestsonline.org.uk/tests/glucose-tests#content)

[Lab Tests Online UK](https://labtestsonline.org.uk/)

[About](https://labtestsonline.org.uk/about)Site search

Search 

Search

1.   [Home](https://labtestsonline.org.uk/)
2.   [Tests](https://labtestsonline.org.uk/tests)

# Glucose Tests

**Note:** this site is for informational purposes only. To view test results or book a test, use the [NHS app](https://www.nhs.uk/nhs-app/account/) in England or contact your GP.
...
1.   [Why get tested?](https://labtestsonline.org.uk/tests/glucose-tests#heading-3631)
2.   [When to get tested?](https://labtestsonline.org.uk/tests/glucose-tests#heading-3633)
3.   [Sample required?](https://labtestsonline.org.uk/tests/glucose-tests#heading-3635)
4.   [Test preparation needed?](https://labtestsonline.org.uk/tests/glucose-tests#heading-3637)
5.   [What is being tested?](https://labtestsonline.org.uk/tests/glucose-tests#heading-3639)
6.   [Common questions](https://labtestsonline.org.uk/tests/glucose-tests#heading-7108)
7.   [Other tests you might need](https://labtestsonline.org.uk/tests/glucose-tests#heading-related-tests)
...
| Between 7.8 – 11.0 mmol/​L | Impaired glucose tolerance |
| 11.1 mmol/​L and above | Probable diabetes |
...
*   [### Continuous Glucose Monitoring Continuous glucose monitoring (CGM) uses a small sensor placed under the skin, usually on the abdomen or arm, that continuously measures glucose levels in the fluid between cells and sends readings to a monitor or smartphone. It is used to monitor glucose levels in people with diabetes, helping track changes throughout the day and guide treatment decisions.](https://labtestsonline.org.uk/tests/continuous-glucose-monitoring)
*   [### Insulin An insulin test measures the level of insulin, a hormone produced by the pancreas, in the blood using a blood sample taken from a vein in the arm, often after a period of fasting. It is used to investigate and monitor conditions affecting blood sugar control, including diabetes, insulin resistance and hypoglycaemia.](https://labtestsonline.org.uk/tests/insulin)
*   [### C-peptide This test measures C-peptide in a blood (and sometimes urine) sample to assess how much insulin the body is producing. It is used to help distinguish between types of diabetes, evaluate insulin deficiency or resistance, and investigate causes of low blood sugar (hypoglycaemia).](https://labtestsonline.org.uk/tests/c-peptide)
*   [### Glucose Tests Glucose tests measure the level of glucose in a blood sample, which may be taken from a vein or via a finger-prick, sometimes after fasting or as part of a glucose tolerance test. They are used to screen for, diagnose, and monitor diabetes and other conditions affecting blood sugar control.](https://labtestsonline.org.uk/tests/glucose-tests)
*   [### HbA1c Test A HbA1c test measures glycated haemoglobin (HbA1c) in a blood sample, reflecting the average blood glucose level over the previous 2–3 months. It is used to screen for, diagnose, and monitor diabetes, helping guide long-term management and treatment decisions.](https://labtestsonline.org.uk/tests/hba1c-test)
*   [### Urine Albumin to Creatinine Ratio or ACR The urine albumin-to-creatinine ratio (ACR) test is a urine test in which a single urine sample is collected and analysed to compare the amount of albumin with creatinine. It is used to screen for and detect early kidney damage, particularly in people with diabetes or high blood pressure.](https://labtestsonline.org.uk/tests/urine-albumin-creatinine-ratio-or-acr)
*   [### Urinalysis Urinalysis is a urine test in which a urine sample is examined using dipstick, microscopic and sometimes chemical analysis to assess its physical and chemical properties. It is used to help detect urinary tract infections, kidney disease and metabolic conditions, as well as to monitor overall health.](https://labtestsonline.org.uk/tests/urinalysis)
*   [### Fructosamine A fructosamine test measures fructosamine levels in a blood sample, reflecting the amount of glucose bound to proteins in the blood over the previous 2–3 weeks. It is used to monitor short-term blood glucose control in people with diabetes, particularly when HbA1c testing is not suitable.](https://labtestsonline.org.uk/tests/fructosamine)

## Related links

*   [NHS: Diabetes](https://www.nhs.uk/conditions/diabetes/)
*   [NHS: Pregnancy](https://www.nhs.uk/pregnancy/)
*   [Urinary tract infection](https://www.nhs.uk/conditions/urinary-tract-infections-utis/)
*   [Cushing's syndrome](https://www.nhs.uk/conditions/cushings-syndrome/)
*   [Hyperthyroidism](https://www.nhs.uk/conditions/overactive-thyroid-hyperthyroidism/)
*   [Pancreatic cancer](https://www.nhs.uk/conditions/pancreatic-cancer/)
*   [Pancreatitis](https://www.nhs.uk/conditions/acute-pancreatitis/)
*   [Addison's disease](https://www.nhs.uk/conditions/addisons-disease/)
*   [Liver disease](https://www.nhs.uk/conditions/liver-disease/)

 Back to top

## Website ownership and funding

Website owned and managed by

[](https://labmed.org.uk/)

Collaboration and funding by

[](https://www.rcpath.org/)[](https://www.ibms.org/)

*   [Contact](https://labtestsonline.org.uk/contact)
*   [About](https://labtestsonline.org.uk/about)
*   [Cookies](https://labtestsonline.org.uk/cookies)
*   [Policies](https://labtestsonline.org.uk/privacy-policy)
*   [Tests A to Z](https://labtestsonline.org.uk/tests)

©2026 The Association for Laboratory Medicine

Website by [William Joseph (opens in a new tab)](https://www.williamjoseph.co.uk/)
