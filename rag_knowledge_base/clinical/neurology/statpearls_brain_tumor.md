...
note: StatPearls — Brain tumor clinical overview (curated)
...
- Primary brain tumors: ~300,000 new cases/year worldwide
- Glioblastoma (GBM): most common malignant primary brain tumor in adults (~45% of malignant gliomas)
- Meningiomas: most common benign intracranial tumor (~37% of all primary brain tumors)
- Brain metastases: 10–30x more common than primary brain tumors (lung, breast, melanoma, renal, colon)
- Peak incidence: GBM age 55–75; pilocytic astrocytoma age 10–20; medulloblastoma age 3–16

## Clinical Presentation

### General Symptoms (Raised ICP)
- Headache: morning, worsened by Valsalva/straining/lying flat, associated nausea/vomiting
- Papilloedema on fundoscopy (indicates chronic raised ICP)
- Cognitive impairment, personality change
- New-onset seizures in adults

### Focal Neurological Deficits
- Depend on tumour location (see WHO classification file)
- Todd’s paresis: transient focal weakness post-seizure — suggests seizure focus

## Key Differentials on MRI

| MRI Pattern | Common Diagnoses |
|---|---|
| Ring-enhancing lesion | GBM, brain abscess, metastasis, tumefactive MS |
| Non-enhancing T2/FLAIR hyperintensity | Low-grade glioma, oedema, demyelination |
| Homogenous enhancement, dural-based | Meningioma ("tail" sign) |
| Multiple enhancing lesions | Metastases, lymphoma, abscesses |
| Periventricular enhancement | PCNSL (lymphoma), toxoplasmosis (immunocompromised) |
| T1 hyperintense | Melanoma metastasis, haemorrhage, fat, protein |

## Distinguishing GBM vs Brain Abscess vs Metastasis

| Feature | GBM | Brain Abscess | Metastasis |
|---|---|---|---|
| Enhancement | Irregular ring | Smooth thin ring | Smooth thick ring |
| DWI | Low (necrosis) | **High** (pus = restricted diffusion) | Low |
| Surrounding oedema | Extensive | Moderate | Variable |
| Location | White matter | Grey-white junction | **Grey-white junction** |
| Number | Usually solitary | Solitary or multiple | Often multiple |
| Fever, raised WBC | No | **Yes** | No |

## Prognostic Markers

| Marker | Significance |
|---|---|
| IDH mutation | Better prognosis (WHO 2–3 gliomas) |
| MGMT promoter methylation | Predicts benefit from temozolomide (GBM) |
| 1p/19q codeletion | Oligodendroglioma; better prognosis + chemo response |
| TERT mutation (IDH-wildtype) | Aggressive; classify as GBM even if Grade 2–3 histology |
| EGFR amplification | GBM; poor prognosis |

## Emergency Management

### Raised ICP
- Head of bed 30–45°
- Avoid hypoxia (target SpO₂ > 94%) and hyponatraemia
- **Dexamethasone 10 mg IV bolus then 4 mg QID** (reduces peritumoral vasogenic oedema rapidly)
- Mannitol 1 g/kg IV for acute herniation
- Hyperventilation (temporary measure): target PaCO₂ 30–35 mmHg
- Neurosurgery referral for emergent decompression

### Seizure Management
- First seizure: MRI brain urgently; start AED (levetiracetam preferred, no enzyme induction)
- Status epilepticus: benzodiazepine (lorazepam IV) → levetiracetam/fosphenytoin → anaesthetic if refractory

## Priority Level

- Known tumour, stable clinic follow-up: **ROUTINE**
- New headache + neurological signs + imaging scheduled: **PRIORITY**
- Acute herniation, status epilepticus, GCS decline: **URGENT**
