...
async def list_specialties(
    use_case: Annotated[ListSpecialtiesUseCase, Depends(get_list_specialties_use_case)]
):
...
async def create_specialty(
    dto: SpecialtyDTO,
    use_case: Annotated[SaveSpecialtyUseCase, Depends(get_save_specialty_use_case)]
):
    try:
